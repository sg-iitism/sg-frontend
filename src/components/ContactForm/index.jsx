    ...
    <ContactContainer>
      <Row justify="space-between" align="middle">
        <Col lg={12} md={12} sm={24} xs={24} order={1}>
          ...
          <div style={{width: "97%", marginLeft: "20px"}}>
          <p>Login with your college email ID in icognito mode and then open this page to access the contact form</p>
          </div>
          <iframe src="https://docs.google.com/forms/d/e/1FAIpQLSec2xPGgebmqHADExKLLHHF_puweEProdVYTUBMim8GCS3dIA/viewform?embedded=true" title="Contact Form" width="98%" height="840" frameborder="0" marginheight="0" marginwidth="0"><Spin/></iframe>
          </Slide>
        </Col>
